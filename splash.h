...
RgbColor splash[8][32]{
  ...
  {bls,rai,bls,bls,bls,rai,red,azr,bls,bls,red,bls,bls,sno,bls,bls,bls,bls,sno,bls,bls,sno,sno,bls,bls,sno,sno,bls,sno,bls,sno,bls},
  ...
  {bls,rai,rai,bls,rai,rai,red,azr,bls,bls,red,bls,bls,bls,sno,sno,bls,bls,sno,bls,bls,sno,bls,bls,bls,sno,sno,bls,sno,bls,sno,bls},
  {bls,bls,bls,bls,bls,bls,bls,bls,bls,bls,bls,bls,bls,bls,bls,bls,bls,bls,bls,bls,bls,bls,bls,bls,bls,bls,bls,bls,bls,bls,bls,bls}
};
